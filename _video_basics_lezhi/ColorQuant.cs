 ...
 *------------------------------------------------------------------------*/
    ...
    public class ColorQuant
    {
        ...
        public Colormap MedianCutQuantGeneral(VideoIN pixs, int maxcolors)////////////////////
        {
            return MedianCutQuantGeneral(new PIX(pixs), 1, maxcolors, 1);
        }

        public Colormap MedianCutQuantGeneral(VideoIN pixs, int ditherflag, int maxcolors, int maxsub)////////////
        {
