...
namespace testmediasmall
{
    ...
    public class MediaWindow
    {
        ...
        public void Initialize()
        {
            ...
            //Video.SetResolution(560, 360);
            //CalibrationVideo.SetResolution(560, 360);
        }
        ...
        void VisualizeGaze()
        {
            ...
            //if (frameNumber > minframes - startFade_gaze) { GL.Color4(255.0 / 255.0, 0.0, 0.0, alpha_gaze); }
            { GL.Color4(255.0 / 255.0, 0.0, 0.0, alpha_gaze); }
